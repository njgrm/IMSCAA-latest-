...
export default function DateRangePicker({ value, onChange }: Props) {
  ...
  const CustomInput = React.forwardRef<HTMLInputElement, any>(
    ({ value, onClick, placeholder }, ref) => (
      <div className="relative w-full min-w-0 sm:w-48 sm:flex-shrink-0">
  ...
  return (
    <div className="flex w-full min-w-0 flex-col items-stretch gap-2 sm:flex-row sm:items-center sm:gap-2">
